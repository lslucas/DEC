  <div class='error container-error'><div class='error-icon'>
	...
	<ol>
		...
		<li><label for="titulo" class="error-validate">Coloque a legenda</label></li>
		<li><label for="data" class="error-validate">Informe uma data válida</label></li>
		<li><label for="link" class="error-validate">Informe uma url válida</label></li>
	</ol>
  </div>
...
<p class='header'>Todos os campos com <b>- * -</b> são obrigatórios.</p>
	...
	<li>	
	  <label>Legenda<span class='small'>Legenda do destaque</span></label>
	  <input type='text' name='titulo' id='titulo' value='<?=$val['titulo']?>'>
	</li>

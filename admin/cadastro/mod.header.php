...
<script>
   ...
   **************************/
   ...
   $('#orderby').change(function(){
    window.location.href='?p=cadastro${pag}&orderby='+$(this).val();
   });
    ...
    $LOADING
      ...
      data: 'item='+id_status,
			success: function(data){
			 ...
			 if(texto_status=='Banir') {
			   $('.status'+id_status).html('<font class="green">Re-ativar</font>');
			   $('#status'+id_status).html('<font class="red">Banido</font>');

         } else {
			    $('.status'+id_status).html('<font class="red">Banir</font>');

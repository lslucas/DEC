<?php
 ...
 if(isset($_GET['verifica'])) {
	...
	if (file_exists($var['path'].'/mod.r_not_categoria.delete.php')) 
	 include_once $var['path'].'/mod.r_not_categoria.delete.php';
	
	if (file_exists($var['path'].'/mod.r_not_imagem.delete.php')) 
	 include_once $var['path'].'/mod.r_not_imagem.delete.php';

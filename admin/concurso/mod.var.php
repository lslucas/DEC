...
#UPLOAD DE ARQUIVOS
    $var['path_arquivo']   = PATH_IMG.'/'.$var['path'];
    $var['arquivo_folderlist'] = $var['path_arquivo'];




    $field  = array('conc_id', 'conc_titulo', 'conc_data', 'conc_data_resultado', 'conc_data_validade', 'conc_data_prova', 'conc_cat_id', 'conc_texto', 'conc_inscricao');
